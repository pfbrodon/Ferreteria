...
###########################################################################
#CONFIGURACION INICIAL VENTANAMain PRINCIPAL
ventanaMain= ctk.CTk()
#ventanaMain=tk.Tk()
ventanaMain.geometry("720x680+10+10")#TAMAÑO Y UBICACION CON RESPECTO A LA PANTALLA                                                    
ventanaMain.title("CONTROL DE INVENTARIO")#TITULO
ventanaMain.resizable(width=False,height=False)#BLOQUEO DE REDIMENSION
ventanaMain.configure(background="lightblue")#COLOR DE FONDO DE VENTANAMain
ventanaMain.bind('<F1>', lambda event: activarValorizar())
ventanaMain.bind('<F2>', lambda event: activarCargaLPrecios())

#CREACION DE UN MARCO#########################################
#    cuadro1=tk.Frame(ventanaMain,width=300,height=100,highlightthickness=2)
...
sumaStock=()
#ENTRY#############################################################################################
entradaCodigo=ttk.Entry(ventanaMain,font=("Arial",9),width=7 ,justify="right",textvariable=codigoBusq)
entradaCodigo.place(x=110,y=50)
entradaCategoria=ttk.Entry(ventanaMain,font=("Arial",9),width=12, textvariable=itemTabla)
entradaCategoria.place(x=110,y=80)
entradaDescripcion=ttk.Entry(ventanaMain,font=("Arial",9),width=40, textvariable=itemTabla)
entradaDescripcion.place(x=110,y=110)
entradaCantidad=ttk.Entry(ventanaMain,font=("Arial",9),width=5,justify="right",textvariable=itemTabla)
entradaCantidad.place(x=110,y=140)
entradaPrecio=ttk.Entry(ventanaMain,font=("Arial",9),width=10,justify="right", textvariable=itemTabla)
entradaPrecio.place(x=110,y=170)
entradaPrecioVP=ttk.Entry(ventanaMain,font=("Arial",9),width=10,justify="right",textvariable=itemTabla)
...
lbl1=ttk.Label(ventanaMain, text='VALOR DE STOCK EXISTENTE:',background='lightblue')
lbl1.place(x=10,y=10)
lbl10=ttk.Label(ventanaMain, text='',background='lightblue')
lbl10.place(x=168,y=8)
########################################################
lblCodigo=ttk.Label(ventanaMain, text='CODIGO:',background='lightblue')
lblCodigo.place(x=10,y=50)
lblCategoria=ttk.Label(ventanaMain, text='CATEGORIA:',background='lightblue')
lblCategoria.place(x=10,y=80)
lblDescripcion=ttk.Label(ventanaMain, text='DESCRIPCION:',background='lightblue')
lblDescripcion.place(x=10,y=110)
lblCantidad=ttk.Label(ventanaMain, text='CANTIDAD:',background='lightblue')
lblCantidad.place(x=10,y=140)
lblPrecio=ttk.Label(ventanaMain, text='PRECIO COSTO:',background='lightblue')
lblPrecio.place(x=10,y=170)
lblPrecioVP=ttk.Label(ventanaMain, text='PRECIO VP:',background='lightblue')
...
#BOTONES#########################################################################################
btn1=ttk.Button(ventanaMain, text='F1-VALORIZAR', command=valorizarStock, style='EstiloBoton1.TButton',width=25)
btn1.place(x=520,y=10)
#btn1.config(font=11)
#######################################
btn2=ttk.Button(ventanaMain, text='BUSCAR CODIGO', command=busquedaCodigo,style='EstiloBoton1.TButton',width=25)
btn2.place(x=520,y=90)
#######################################
btn3=ttk.Button(ventanaMain,text='BUSCAR DESCRIPCION', command=busquedaDescripcion,style='EstiloBoton1.TButton',width=25)
btn3.place(x=520,y=50)
#######################################
btn4=ttk.Button(ventanaMain, text='F2-LISTA DE PRECIOS', command=mostarTabla,style='EstiloBoton1.TButton',width=25)
btn4.place(x=520,y=170)
#######################################
btnModificar=ttk.Button(ventanaMain,text='MODIFICAR PRODUCTO', state=DISABLED, command=modificarProducto,style='EstiloBoton5.TButton',width=25)
btnModificar.place(x=320,y=10)
#mostrarModificar(False)
#######################################
btn6=ttk.Button(ventanaMain,text='ALTA PRODUCTO', command=moduloCarga,style='EstiloBoton4.TButton',width=25)
btn6.place(x=320,y=170)
#######################################
btn7=ttk.Button(ventanaMain,text='BAJA PRODUCTO', command=borrarProducto,style='EstiloBoton2.TButton',width=25)
btn7.place(x=320,y=210)
#######################################
btn8=ttk.Button(ventanaMain,  text='LIMPIAR ENTRADA', command=limpiarEntry,style='EstiloBoton1.TButton',width=25)
btn8.place(x=520,y=210)
#######################################
btn9=ttk.Button(ventanaMain, text='EXPORTAR LISTA', command=exportatExcel,style='EstiloBoton1.TButton',width=25)
btn9.place(x=520,y=130)
#######################################
btn10=ttk.Button(ventanaMain, text='MODULO REMITO',command= print("en preparacion"),style='EstiloBoton1.TButton',width=25)
